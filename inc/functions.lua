...
──▀████████▀──│@OMAR_707
─────▀██▀─────
│تم تويره وزرفه من قبل عمر الغامدي
│@OMAR_707
#-------------------------------------------------------------------
]]
...
if redis:get(max..'group:add'..msg.chat_id_) then  return '*-›* المجموعه مفعله من قبل يالطيب! ' end
...
if not redis:get(max..'group:add'..msg.chat_id_) then return '*-›* المجموعه معطله من قبل يالطيب!' end  
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"*-›* مايمديك تقييد Myth ") 
elseif redis:sismember(max..':SUDO_BOT:',UserID) then 
...
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› منشىء اساسي️ من قبل',17,USERCAR) 
end
redis:hset(max..'username:'..UserID,'username',Resolv)
redis:sadd(max..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› تم الترقية صار منشىء اساسي في البوت️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(max..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› مو منشىء اساسي من قبل️',17,USERCAR) 
end
...
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› تم الترقية صار عضو مميز️',17,USERCAR) 
end
...
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› تم الترقية صار مدير️',17,USERCAR) 
end
...
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› تم الترقية صار ادمن️',17,USERCAR) 
end
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"*-›* مايمديك تحظر Myth ") 
elseif redis:sismember(max..':SUDO_BOT:',UserID) then 
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"*-›* مايمديك تكتم Myth ياورع ") 
elseif redis:sismember(max..':SUDO_BOT:',UserID) then 
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"*-›* مايمديك تطرد Myth ") 
elseif redis:sismember(max..':SUDO_BOT:',UserID) then 
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"*-›* لا يمكنك حظر Myth ")
elseif redis:sismember(max..':SUDO_BOT:',UserID) then 
...
redis:hset(max..'username:'..UserID, 'username', Resolv)
redis:sadd(max..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› تم الترقية صار عضو مميز ️',17,USERCAR) 
end
if cmd == "setmnsha" then
if redis:sismember(max..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› منشئ من قبل',17,USERCAR) 
...
redis:hset(max..'username:'..UserID, 'username', Resolv)
redis:sadd(max..'admins:'..ChatID,UserID) 
return SendMention(ChatID,UserID,MsgID,'-› العضو ❪ '..USERNAME..' ❫\n-› الايدي ❪ '..UserID..' ❫\n-› تم الترقية صار ادمن ️',17,USERCAR) 
end
if cmd == "remowner" then
if not redis:sismember(max..'owners:'..ChatID,UserID) then 
